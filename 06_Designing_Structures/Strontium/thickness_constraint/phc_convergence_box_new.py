...
def create_fsp_file(params, i, num_iter):
    ...
    wSimVolZ = 8e-6  # propagation direction (okay it's also thickness direction)
    ...
    aPhC = 941.554e-9  # Lattice constant
    tTether = 170e-9
    multiplier = 0.25 * aPhC
...
a = 941.554e-9  # Lattice constant of structure
tSiN = 200e-9
