...
def create_fsp_file(i, name):
    ...
    wSimVolXY = 6.0e-6  # 8.0e-6  # The 2D PhC plane
    wSimVolZ = (
        3e-6  # 12.0e-6  # propagation direction (okay it's also thickness direction)
    )
    ...
    aPhC = 383.65e-9  # Lattice constant
    tTether = 170e-9
    ...
    dipole_source["x"] = 0  # Normally this is 0
    dipole_source["y"] = 0  # Normally this is 0
    dipole_source[
        "z"
