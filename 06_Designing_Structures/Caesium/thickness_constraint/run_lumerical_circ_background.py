...
def create_fsp_file(name):
    ...
    # EFFECT FOR wSimVolXY = 8.0
    wSimVolXY = 10.0e-6  # The 2D PhC plane
    ...
    # OTHER PARAMETERS
    # EFFECT FOR wMarginXY = 0.5
    wMarginXY = 2.5e-6  # Margin width where there will be no holes in the supercell
    ...
    freqhighres = 500  # For more detailed plots

    timefactor = 500.0  # as in t = (time factor) * lZ / c - actually use 2PhC XY-size
