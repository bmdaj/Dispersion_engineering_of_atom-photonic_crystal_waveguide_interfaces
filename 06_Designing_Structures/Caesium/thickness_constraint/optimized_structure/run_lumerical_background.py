...
def create_fsp_file(i, name, aPhC, multiplier):
    ...
    wSimVolXY = 3.0e-6  # The 2D PhC plane
    ...
    freqhighres = 1000  # Normally, 2000 For more detailed plots

    timefactor = 300.0  # Normally, 1000 as in t = (time factor) * lZ / c - actually use 2PhC XY-size
    ...
    dipole_source["x"] = px1[indH0]  # Normally this is 0
    dipole_source["y"] = py1[indH0]  # Normally this is 0
    dipole_source[
        "z"
