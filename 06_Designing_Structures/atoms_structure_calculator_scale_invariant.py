...
def calculate_freqs(params):
    ...
    return tm_band_freq, midgap_freq
...
print("thickness at maximum: {}".format(result.x[1]))
...
tm_band_freq, midgap_freq = calculate_freqs(params)
