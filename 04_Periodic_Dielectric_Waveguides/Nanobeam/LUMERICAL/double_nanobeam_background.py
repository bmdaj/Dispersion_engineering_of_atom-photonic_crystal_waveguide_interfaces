...
def create_fsp_file(i, name):
    ...
    timefactor = 250.0  # as in t = (time factor) * lX / c
    ...
    fdtd.setresource("FDTD", 1, "processes", "4")  # We use ? processes
    #  -------------------------------------------------------------------------------------
    ...
    profile["y"] = 0
    profile["z"] = 0
    profile["x min"] = -wSimVolX
    profile["x max"] = +wSimVolX
    profile["x span"] = 2 * wSimVolX
    profile["y min"] = -wSimVolY
    profile["y max"] = +wSimVolY
    profile["y span"] = 2 * wSimVolY
